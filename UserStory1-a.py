...
if numOfDefenders != 0:
    ...
    queryString_partOne = {"$and": [{"Position": "Defender"}, {"Performance": {"$gt": "1"}}, {"Team": userInputTeam}]}
...
if numOfAttacker != 0:
    ...
    queryString_partOne = {"$and": [{"Position": "Attacker"}, {"Performance": {"$gt": "1"}}, {"Team": userInputTeam}]}
    queryString_partTwo = {"Name": 1, "_id": 0, "Performance": 1,"Position": 1}
    queryString_partThree ="{" " Performance" ":-1}"
...
if numOfMidfielder != 0:
    ...
    queryString_partOne = {"$and": [{"Position": "Midfielder"}, {"Performance": {"$gt": "1"}}, {"Team": userInputTeam}]}
    queryString_partTwo = {"Name": 1, "_id": 0, "Performance": 1, "Position": 1}
    queryString_partThree ="{" " Performance" ":-1}"
